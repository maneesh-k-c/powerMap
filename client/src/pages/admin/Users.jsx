...
export default function Users() {
    ...
    console.log(users);
    useEffect(() => {
        axios.get('http://localhost:4000/auth/all-users')
            .then(res => {
                setUsers(res.data.data)
            })
    }, [])
    const reject = (id) => {
        axios.post(`http://localhost:4000/auth/reject_user/${id}`)
            .then(res => {
                console.log(res.data);
                const deleteusers = users.filter((user) => {
                    return user.login_id._id != id
                })
                            ...
                            <div className="col-lg-2 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div className="team-item">
                                    ...
                                    >
                                        ...
                                        <a className="btn btn-square mx-1" href="" onClick={() => { reject(user.login_id._id) }}>
                                            ❌
                                        </a>
                                    </div>
